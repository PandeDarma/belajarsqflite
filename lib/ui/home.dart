...
import 'package:flutterbelajarsqlite/ui/daftar.dart';
import 'package:flutterbelajarsqlite/models/kontak.dart';
import 'package:flutterbelajarsqlite/helpers/helper_databases.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: <Widget>[ 
          IconButton(
            icon: Icon(Icons.add, color: Colors.blueAccent[800], size: 28),
            onPressed: () async {
